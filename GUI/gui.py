...
# Screen 1 - upload screen 
    ...
    upload_screen = customtkinter.CTkFrame(master=app, fg_color='#f2f2f2')
    upload_screen.grid(row=1,column=0)

    #file finder
    file_frame = customtkinter.CTkFrame(master=upload_screen,width=400, height=200, fg_color='#f2f2f2')
    ...
    def display_filename():
        ...
        file_button.configure(text=file_name)
...
# ----------------------------------------------------------------------------------------------------------------------------------
# screen 1 - excel input screen 
# input_screen = customtkinter.CTkButton(master=app, )




# screen 2 - conversion complete screen 
